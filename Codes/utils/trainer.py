...
def train(env, get_action: Callable[[List[float]], int], update_agent: Callable[[List[Rollout]], None],
    ...
    for epoch in range(epochs):
        ...
        KL_diff, L_improvement = update_agent(rollouts)
        ...
        KL_diff_history.append(KL_diff)
        surrogate_loss_history.append(L_improvement)
        reward_history.append(mean(rollout_rewards))

    return KL_diff_history, surrogate_loss_history, reward_history
